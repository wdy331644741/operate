...
{
    if (IS_POST) {
        $title = $amount = $minAmount = $maxAmount = $days = $effectiveEnd = $limitDesc = $limitNode = $status = null;
        $requireFields = ['title', 'amount', 'minAmount', 'maxAmount', 'days', 'effectiveEnd', 'limitDesc', 'limitNode', 'status'];
